    ...
    describe('SIGN-UP FORM', () => {
        ...
        describe('ERRORS', () => {
            ...
            it('should show an error if the password does not contain at least one capital letter', () => {
                interceptSignUpWithError('Password must contain at least one capital letter');
...
const interceptSignUpWithError = (errorMessage: string) => {
    cy.intercept('POST', `${apiBaseUrl}users/signup`,
        {
            statusCode: 400,
